...
var BootstrapVue = _interopDefault(require('bootstrap-vue'));
var fontawesomeSvgCore = require('@fortawesome/fontawesome-svg-core');
var freeSolidSvgIcons = require('@fortawesome/free-solid-svg-icons');
var vueFontawesome = require('@fortawesome/vue-fontawesome');
var Vue = _interopDefault(require('vue'));
var Vuex = _interopDefault(require('vuex'));
var d3annotation = require('d3-svg-annotation');
var d3annotation__default = _interopDefault(d3annotation);
var JSum = _interopDefault(require('jsum'));
var VegaEmbed = _interopDefault(require('vega-embed'));
var d3 = require('d3');
var lodash = _interopDefault(require('lodash'));
var tiptap = require('tiptap');
var tiptapExtensions = require('tiptap-extensions');
var Swatches = _interopDefault(require('vue-swatches'));
